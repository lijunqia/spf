...
class Taf_svr
{
	static function loadDepends()
	{
		class_exists(__NAMESPACE__.'\JCEException');
		class_exists(__NAMESPACE__.'\jce');
		jce_header::initial();
		class_exists(__NAMESPACE__.'\UniPacket');
		class_exists(__NAMESPACE__.'\RequestPacket');
		class_exists(__NAMESPACE__.'\ResponsePacket');
		class_exists(__NAMESPACE__.'\pdu_unipacket');
	}
	/**
	 * 创建socket连接
	 *
